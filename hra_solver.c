                ...
                int* schedule)
{
    ...
    for (int i = 0; i < task_dependency_count; i++)
    {
        ...
        combination_list[combination_list_index + 6] = task_dependencies[task_dependency_index] + 1;
        combination_list[combination_list_index + 7] = task_dependencies[task_dependency_index + 1] +1;
        ...
        combination_list[combination_list_index + 15] =
            ...
            task_costs[2 * (task_dependencies[task_dependency_index + 1] - 1)];
        combination_list[combination_list_index + 16] = task_dependencies[task_dependency_index] + 1;
